  ...
  return (
    <header className="header">
      ...
      <nav className="navbar">
        <Link to="/china#home" data-aos="zoom-in-left" data-aos-delay="150">
          Home
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="200" to="/china#about">
          About
        </Link>
        <Link
          data-aos="zoom-in-left"
          data-aos-delay="250"
          to="/china#destination"
        >
          Điểm đến
        </Link>
        <Link
        ...
        <Link data-aos="zoom-in-left" data-aos-delay="350" to="/china#gallery">
          Ảnh
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="400" to="/china#blogs">
          blogs
        </Link>
      </nav>
      <i
