  ...
  return (
    <header className="header">
      ...
      <nav className="navbar">
        <Link to="/laocai#home" data-aos="zoom-in-left" data-aos-delay="150">
          Home
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="200" to="/laocai#about">
          About
        </Link>
        <Link
          data-aos="zoom-in-left"
          data-aos-delay="250"
          to="/laocai#destination"
        >
          Điểm đến
        </Link>
        <Link
        ...
        <Link data-aos="zoom-in-left" data-aos-delay="350" to="/laocai#gallery">
          Ảnh
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="400" to="/laocai#blogs">
          blogs
        </Link>
      </nav>
      <i
