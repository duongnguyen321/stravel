  ...
  return (
    <header className="header">
      ...
      <nav className="navbar">
        <Link to="/russia#home" data-aos="zoom-in-left" data-aos-delay="150">
          Home
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="200" to="/russia#about">
          About
        </Link>
        <Link
          data-aos="zoom-in-left"
          data-aos-delay="250"
          to="/russia#destination"
        >
          Điểm đến
        </Link>
        <Link
        ...
        <Link data-aos="zoom-in-left" data-aos-delay="350" to="/russia#gallery">
          Ảnh
        </Link>
        <Link data-aos="zoom-in-left" data-aos-delay="400" to="/russia#blogs">
          blogs
        </Link>
      </nav>
      <i
