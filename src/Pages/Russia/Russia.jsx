import Header from "../../components/russia/Header";
import Footer from "../../components/russia/Footer";
...
class Home extends React.Component {
  ...
  componentDidMount() {
    fetch("https://apiforstravel.herokuapp.com/pages/7")
      .then((res) => res.json())
      .then(
        (result) => {
          this.setState({
      ...
      <section className="book-form" id="book-form">
        <form action="">
          ...
          <div data-aos="zoom-in" data-aos-delay="100" className="inputBox">
            <span>
              <Link className="btn btn-book" to="/russia/book">
                Đặt ngay
              </Link>
            </span>
          </div>
    ...
    return (
      <section className="destination" id="destination">
        <div className="heading">
          <span>Những điểm đến ở Russia</span>
      ...
      <section className="review">
        <div className="content" data-aos="fade-right" data-aos-delay="250">
          ...
          <p>
            ...
            triển. đây là những đánh giá tốt nhất về chuyến đi Russia này.
          </p>
        </div>
  ...
  return (
    <div className="banner">
      <div className="content" data-aos="zoom-in-up" data-aos-delay="250">
        ...
        <Link to="/russia/book" className="btn">
          Đặt Ngay
        </Link>
      </div>
    </div>
...
export default function Russia() {
  ...
  return (
    <div className="Pages Russia" onScroll={handleScroll}>
      <Header />
