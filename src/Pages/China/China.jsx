import Header from "../../components/china/Header";
import Footer from "../../components/china/Footer";
...
class Home extends React.Component {
  ...
  componentDidMount() {
    fetch("https://apiforstravel.herokuapp.com/pages/8")
      .then((res) => res.json())
      .then(
        (result) => {
          this.setState({
      ...
      <section className="book-form" id="book-form">
        <form action="">
          ...
          <div data-aos="zoom-in" data-aos-delay="100" className="inputBox">
            <span>
              <Link className="btn btn-book" to="/china/book">
                Đặt ngay
              </Link>
            </span>
          </div>
    ...
    return (
      <section className="destination" id="destination">
        <div className="heading">
          <span>Những điểm đến ở China</span>
      ...
      <section className="review">
        <div className="content" data-aos="fade-right" data-aos-delay="250">
          ...
          <p>
            ...
            triển. đây là những đánh giá tốt nhất về chuyến đi China này.
          </p>
        </div>
  ...
  return (
    <div className="banner">
      <div className="content" data-aos="zoom-in-up" data-aos-delay="250">
        ...
        <Link to="/china/book" className="btn">
          Đặt Ngay
        </Link>
      </div>
    </div>
...
export default function China() {
  ...
  return (
    <div className="Pages China" onScroll={handleScroll}>
      <Header />
