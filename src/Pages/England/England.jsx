import Header from "../../components/england/Header";
import Footer from "../../components/england/Footer";
...
class Home extends React.Component {
  ...
  componentDidMount() {
    fetch("https://lccspy-3000.csb.app/pages/9")
      .then((res) => res.json())
      .then(
        (result) => {
          this.setState({
      ...
      <section className="book-form" id="book-form">
        <form action="">
          ...
          <div data-aos="zoom-in" data-aos-delay="100" className="inputBox">
            <span>
              <Link className="btn btn-book" to="/england/book">
                Đặt ngay
              </Link>
            </span>
          </div>
    ...
    return (
      <section className="destination" id="destination">
        <div className="heading">
          <span>Những điểm đến ở England</span>
  ...
  render() {
    return (
      <section className="gallery" id="gallery">
        <div className="heading">
          <span>
            <h2>những bức Ảnh về England</h2>
          </span>
        </div>
        <div className="box-container">
    ...
    return (
      <section className="blogs" id="blogs">
        <div className="heading">
          ...
          <h1>Tìm hiểu thêm về England</h1>
        </div>
        <div className="box-container">
      ...
      <section className="review">
        <div className="content" data-aos="fade-right" data-aos-delay="250">
          ...
          <p>
            ...
            triển. đây là những đánh giá tốt nhất về chuyến đi England này.
          </p>
        </div>
  ...
  return (
    <div className="banner">
      <div className="content" data-aos="zoom-in-up" data-aos-delay="250">
        ...
        <Link to="/england/book" className="btn">
          Đặt Ngay
        </Link>
      </div>
    </div>
...
export default function England() {
  ...
  return (
    <div className="Pages England" onScroll={handleScroll}>
      <Header />
